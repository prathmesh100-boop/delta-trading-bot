...
Examples:
  ...
  python main.py info --symbol BTC_USDT
    ...
    t.add_argument("--min-confidence",   type=float, default=0.55,  dest="min_confidence")
    t.add_argument("--adx-threshold",    type=float, default=20.0,  dest="adx_threshold")
    t.add_argument("--vol-factor",       type=float, default=1.2,   dest="vol_factor")
    t.add_argument("--sl-atr-mult",      type=float, default=1.5,   dest="sl_atr_mult")
    t.add_argument("--tp-rr",            type=float, default=2.5,   dest="tp_rr",         help="Risk-reward ratio for TP")
