...
SYMBOL_SPECS: Dict[str, SymbolSpec] = {
    ...
    "AVAXUSD": SymbolSpec(leverage=10.0, fallback_lot_size=1.0, margin_per_lot_usd=0.96),
    ...
    "AVAX_USDT": SymbolSpec(leverage=10.0, fallback_lot_size=1.0, margin_per_lot_usd=0.96),
}
